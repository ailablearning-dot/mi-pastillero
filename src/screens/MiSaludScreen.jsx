...
//
// La distinción con "Hoy" no es cosmética y decide dónde va cada cosa: Hoy y el historial son el
// mismo eje —mi día, mis días—, así que el historial vive dentro de Hoy. Aquí va lo que no depende
// de una fecha: por qué tomo lo que tomo, a qué soy alérgico, qué me diagnosticaron.
//
...
export default function MiSaludScreen({ paciente, pills, onFichaEmergencia, onMisMedicamentos }) {
